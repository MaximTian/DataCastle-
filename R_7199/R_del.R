library(xgboost)
setwd('C:\\Users\\MaximTian\\Desktop\\test\\R_7199')
# read data
train=read.csv('..\\del_columns\\train_del_col.csv')
test=read.csv('..\\del_columns\\test_del_col.csv')
train.y=read.csv('..\\raw_data\\train_y.csv')
ft=read.csv('..\\del_columns\\features_col.csv')
...
write.csv(data.frame('uid'=test.new[,1],'score'=pred),file='R_xgb_del_col.csv',row.names=F)