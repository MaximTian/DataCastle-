...
# read data
train=read.csv('..\\raw_data\\train_x.csv')
test=read.csv('..\\raw_data\\test_x.csv')
train.y=read.csv('..\\raw_data\\train_y.csv')
ft=read.csv('..\\raw_data\\features_type.csv')
...
write.csv(data.frame('uid'=test.new[,1],'score'=pred),file='R_xgb.csv',row.names=F)